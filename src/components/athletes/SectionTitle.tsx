...
const sectionTitleClassNames: Record<SectionTitleSize, string> = {
  ...
  interviewSplit:
    "mt-5 max-w-4xl whitespace-pre-line break-words text-[clamp(2.75rem,5.6vw,5.5rem)] font-semibold uppercase leading-[0.9] text-foreground [overflow-wrap:normal] [text-wrap:balance] motion-safe:animate-[fade-in-up_700ms_ease-out_forwards] motion-safe:translate-y-4 motion-safe:opacity-0 max-sm:[overflow-wrap:anywhere]",
  project:
